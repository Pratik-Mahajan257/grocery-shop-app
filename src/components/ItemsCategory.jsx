...
const ItemsCategory = ({ searchQuery }) => {
              ...
              <div className='flex flex-col absolute right-7 w-1/2 h-full'>
                <div className='flex flex-col'>
                  ...
                  {item.available >= 10 ? (
                   ...
                   <p className='bg-orange-400 shadow-md shadow-orange-300 w-fit py-1 px-4 absolute bottom-24 text-white font-semibold text-sm rounded-full'>Only {item.available} left</p>
                  )}
                </div>
