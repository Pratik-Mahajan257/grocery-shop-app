...
const Header = () => {
  return (
    <div className=' flex items-center gap-x-6 lg:gap-x-28      '>
      <p className='font-bold uppercase text-lg '>Groceries</p>
      <div>
        <input type="text" placeholder='Serach' className=' shadow-md shadow-gray-400 px-2 py-3 outline-none rounded-2xl   border border-gray-200 lg:w-[700px]  ' />
      </div>
